		...
		.catch(err => {
			if (err instanceof IncompleteUserDataError) {
				res.render('nonMemberMessage', {
					message: '<strong>Please go into your "<a href="https://registration.ft.com/registration/selfcare/">My Account</a>" to input your job, industry, and responsibility. Once this has been done you should be able to reapply for a Long Room membership.</strong>'
				});
			} else {
				next(err);
			}
