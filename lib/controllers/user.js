...
const addJoinRequest = (userProfile, formData) => {
	try {
		...
		throw new Error('Please go into your "My Account" to input your job, industry, and responsibility. Once this has been done you should be able to reapply for a Long Room membership.');
	}
