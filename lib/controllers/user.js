			...
			if (err instanceof UserStatusError) {
				if (err.status === 'pending') {
					return res.render('nonMemberMessage', {
						message: 'There is already a pending request for this user.<br/>If you have any questions, please email us at <a href="mailto:alphaville@ft.com">alphaville@ft.com</a>'
					});
				}
