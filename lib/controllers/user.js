		...
		.catch(err => {
			if (err instanceof IncompleteUserDataError) {
				res.render('nonMemberMessage', {
					message: 'Please go into your "My Account" to input your job, industry, and responsibility. Once this has been done you should be able to reapply for a Long Room membership.'
				});
			} else {
				next(err);
			}
