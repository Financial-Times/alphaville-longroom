			...
			if (err instanceof UserStatusError) {
				if (err.status === 'pending') {
					return res.render('nonMemberMessage', {
						message: 'There is already a pending request for this user. If you have any questions, please email us at <a href="mailto:alphaville@ft.com">alphaville@ft.com</a>'
					});
				}

				if (err.status === 'revoked') {
					return res.render('nonMemberMessage', {
						message: 'Your access has been suspended. If you have any questions, please email us at <a href="mailto:alphaville@ft.com">alphaville@ft.com</a>'
					});
				}
